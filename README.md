...
🌐 **Live demo →** [Life Sucks — A Verdict (生活很烂 — 一份裁决)](https://soujiokita98.github.io/playlist-roast-skill/examples/life-sucks/judgment.html)

<p align="center">
  <a href="https://soujiokita98.github.io/playlist-roast-skill/examples/life-sucks/judgment.html">
...
1. **🔥 Roast a playlist.** Generate a doodle-style judgment page (verdict, taxonomy, picks, roast paragraphs, emotional arc) that's screenshot-friendly and exports to PNG with one click. Bilingual toggle for EN/中. See the [live demo](https://soujiokita98.github.io/playlist-roast-skill/examples/life-sucks/judgment.html).
...
```bash
git clone https://github.com/SoujiOkita98/playlist-roast-skill.git
cd playlist-roast-skill
