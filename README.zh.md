...
> 把任意**公开** Spotify 或网易云音乐歌单提取成干净的 JSON，再让 AI 用涂鸦风格的页面锐评你的音乐品味——可截图、可分享、一键导出 PNG。中英双语。

🌐 **在线 Demo →** [Life Sucks — 一份 AI 裁决](https://soujiokita98.github.io/playlist-roast-skill/examples/life-sucks/judgment.html)
...
1. **🔥 锐评一份歌单。** 生成涂鸦风格的「裁决页面」（整体氛围、歌曲分类学、最大众/最装/最混乱选择、锐评、情绪曲线），可截图、可一键导出 PNG，中英文一键切换。看 [Live Demo](https://soujiokita98.github.io/playlist-roast-skill/examples/life-sucks/judgment.html)。
