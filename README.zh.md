...
🌐 **在线 Demo →** [Life Sucks — 一份 AI 裁决](https://soujiokita98.github.io/spotify-roast-skill/examples/life-sucks/judgment.html)
...
1. **🔥 锐评一份歌单。** 生成涂鸦风格的「裁决页面」（整体氛围、歌曲分类学、最大众/最装/最混乱选择、锐评、情绪曲线），可截图、可一键导出 PNG，中英文一键切换。看 [Live Demo](https://soujiokita98.github.io/spotify-roast-skill/examples/life-sucks/judgment.html)。
